...
export const defaultState: LankaState = {
  ...
  stickers: [
    { id: id('st'), columnId: 'sistema', title: 'Definir primer producto Lanka: diagnóstico, auditoría o sistema mensual', note: '', selected: false, createdAt: now(), updatedAt: now() },
    { id: id('st'), columnId: 'tareas', title: 'Pedir a Mathias los 5 KPIs que revisa primero en una auditoría', note: '', selected: false, createdAt: now(), updatedAt: now() },
    { id: id('st'), columnId: 'mercado', title: 'Restaurantes llenos pueden perder dinero', note: '', selected: false, createdAt: now(), updatedAt: now() },
    { id: id('st'), columnId: 'storytelling', title: 'Tu restaurante puede estar lleno y aun así perder dinero', note: '', selected: false, createdAt: now(), updatedAt: now() },
    { id: id('st'), columnId: 'sinResponder', title: '¿Lanka debe mostrarse como consultoría, laboratorio o software?', note: '', selected: false, createdAt: now(), updatedAt: now() },
  ],
  tasks: [
